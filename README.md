...
The dashboard is designed around a set of strategic KPIs that transform
raw sales data into actionable business insights. These metrics provide
a consolidated view of financial performance, customer behavior, order
activity, and sales-channel contribution.

### 🎯 Business Performance at a Glance

| Metric | Value | Insight |
|---|---:|---|
| Total Revenue | ₹159.6 Cr | Overall business revenue |
| Total Profit | ₹35.4 Cr | Overall profitability |
| Profit Margin | 22.15% | Profitability efficiency |
| Total Orders | 20,001 | Overall order volume |
| Average Order Value | ₹7,981.84 | Average value per order |
| Total Quantity | 33,854 | Products sold |
| Online Revenue | ₹86.6 Cr | Online channel contribution |
| Retail Revenue | ₹81.3 Cr | Retail channel contribution |

> **Management Impact:** These KPI cards enable quick performance monitoring and help identify revenue trends, profitability levels, order activity, and channel contribution without manually analyzing the raw dataset.
